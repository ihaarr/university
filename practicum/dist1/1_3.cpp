...
/*
3.	Следом квадратной матрицы называется сумма элементов, расположенных на главной диагонали. 
Дана квадратная матрица А порядка n и натуральное число m. 
По матрице построить вектор B размерности m, где Bi равно следу матрицы Аi , здесь   i=1, 2, … , m. 
